...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+19256955977")
    about_me = models.TextField(verbose_name=_("About Me"), default="say something about yourself")
    license = models.CharField(verbose_name=_("Real Estate license"), max_length=25, blank=True, null=True)
    ...
    city = CountryField(verbose_name=_("City"), max_length=180, default="San Francisco", blank=False, null=False)
